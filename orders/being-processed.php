...
<?php
    $queryResult = $db->query(" SELECT orders.id, name_customer, date_order, status FROM orders JOIN customer ON orders.customer_id = customer.id WHERE status='being-processed'; ");
    $result=array();
